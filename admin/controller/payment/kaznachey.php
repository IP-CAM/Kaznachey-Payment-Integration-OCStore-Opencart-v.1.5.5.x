...
/*         if (isset($this->request->post['kaznachey_paymode'])) {
		...
		if (isset($this->request->post['kaznachey_currency_to_uah'])) {
			$this->data['kaznachey_currency_to_uah'] = $this->request->post['kaznachey_currency_to_uah'];
		} else {
			$this->data['kaznachey_currency_to_uah'] = $this->config->get('kaznachey_currency_to_uah');
		}
