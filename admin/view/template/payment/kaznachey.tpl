  ...
  <div class="content">
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
      <table class="form">
		...
		<tr>
          <td><?php echo $entry_cur_uah; ?></td>
          <td><input type="text" name="kaznachey_currency_to_uah" value="<?php echo (isset($kaznachey_currency_to_uah))?$kaznachey_currency_to_uah:'1'; ?>" size="10" />
		 <br/> <?php echo $entry_cur_uah_desc; ?>
		  </td>
      	</tr>
      </table>
    </form>
